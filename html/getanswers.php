    ...
    <?php
        ...
        $result = mysqli_query($conn, $sql);
         ...
         while($row = mysqli_fetch_assoc($result)) {
            $ans=$row['ans'];
            $ans_uid=$row['ans_uid'];
            echo "<h2 style='text-align: left; margin-top:0%;padding-bottom: 0%; margin-bottom: 0px;padding-bottom: 2%;font-family: Abril Fatface, cursive; font-size: 200%; color: #FFF; margin-left: 35%'>$ans</h2>";
